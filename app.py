...
I18N = {
    "IT": {
        ...
        "disclaimer": "Disclaimer: le valutazioni generate dal simulatore hanno esclusivo scopo illustrativo, non costituiscono consulenza finanziaria o legale, non rappresentano base sufficiente per decisioni di investimento e si basano sui dati inseriti dall'utente.",
    },
    "EN": {
        "language": "Language",
        "guide": "Guide",
        ...
        "disclaimer": "Disclaimer: estimates generated by the simulator are for illustrative purposes only, do not constitute financial or legal advice, are not a sufficient basis for investment decisions, and are based on user-provided inputs.",
    },
}
...
with st.container(border=True):
    ...
    privacy_url = str(_secret_get("privacy_policy_url", "https://storepilot.eu/privacy") or "").strip()
